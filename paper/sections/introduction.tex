...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Cost-Effective Small-Model Deployment}: We demonstrate through multi-model A/B testing that inexpensive small models (qwen3.5-flash, \$0.2/M tokens) outperform expensive frontier models (DeepSeek Chat, \$1/M tokens) when embedded in the expert-ensemble architecture, achieving better quality at approximately 6$\times$ lower cost.
