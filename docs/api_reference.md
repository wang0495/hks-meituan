...
| GET | /health/deep | deep_health_check | 深度健康检查 |
| GET | /health/pools | pool_health | 连接池监控 |
| GET | /health/pools/history | pool_history | 连接池历史统计 |
...
| PATCH |  | test_returns_true_when_dsn_set |  |
| PATCH |  | test_passes_integrations |  |
| PATCH |  | test_calls_sdk_without_context |  |
| PATCH |  | test_calls_sdk_with_context |  |
| PATCH |  | test_calls_sdk |  |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| run | func, iterations | BenchmarkResult |
| _run_sequential | func, iterations, result | None |
| _run_concurrent | func, iterations, concurrency, result | None |
| calculate_metrics | result | PerformanceMetrics |
| run_full | func, iterations | PerformanceMetrics |

---

### backend.benchmarks.locustfile
...
| :--- | :--- | :--- |
| health_check | - | None |
| search_pois_zhuhai | - | None |
| search_pois_beijing | - | None |
| poi_detail | - | None |
| plan_route_relax | - | None |
| check_metrics | - | None |
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| on_test_start | environment | None | 否 |
| on_test_stop | environment | None | 否 |

---

### backend.benchmarks.metrics
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| check_thresholds | metrics, thresholds | list[ThresholdViolation] | 否 |

---

### backend.benchmarks.run_benchmark
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| _create_client | - | httpx.AsyncClient | 否 |
| benchmark_health_check | - | None | 是 |
| benchmark_poi_search | - | None | 是 |
| benchmark_detailed_health | - | None | 是 |
| _print_header | title | None | 否 |
| _print_metrics | metrics | None | 否 |
| _print_threshold_check | metrics | bool | 否 |
| run_scenario | benchmark, name, func, iterations, concurrency | tuple[PerformanceMetrics, bool] | 是 |
| main | args | None | 是 |
| parse_args | - | argparse.Namespace | 否 |

---

### backend.benchmarks.stress_test
...
| _make_request | client, endpoint | RequestResult |
| _user_loop | user_id, duration_s, report, think_time_range | None |
| run_concurrent_test | user_counts, duration_per_level | list[TestReport] |
| run_endurance_test | concurrent_users, duration_minutes, sample_interval_s | TestReport |
| run_spike_test | spike_users, spike_duration_s, cooldown_s, rounds | list[TestReport] |
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| _pick_endpoint | - | Endpoint | 否 |
| save_reports | reports, output_dir | Path | 否 |
| main | - | None | 是 |

---

### backend.benchmarks.__init__
...
### backend.config.__init__

CityFlow 配置包。

向后兼容：``from backend.config import settings`` 仍然可用。
新增：``from backend.config.pool_config import pool_settings``
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| get_openapi_info | - | dict[str, Any] | 否 |
| get_tags_metadata | - | list[dict[str, Any]] | 否 |
| get_openapi_examples | - | dict[str, dict[str, Any]] | 否 |
| get_servers | - | list[dict[str, str]] | 否 |
| get_swagger_css_content | - | str | 否 |

---

### backend.docs.custom_swagger
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | critical_only | None |
| register | name, check_func | None |
| run | - | dict[str, Any] |
| _aggregate | report | dict[str, Any] |

#### 函数

| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| check_disk_space | - | CheckResult | 是 |
| check_memory | - | CheckResult | 是 |
| run_deep_check | - | dict[str, Any] | 是 |

---

### backend.health.__init__
...
### backend.resilience.fault_detector
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | service, level, failure_count, threshold | None |
| to_dict | - | dict[str, Any] |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | threshold, window_sec, history_size | None |
| record_failure | service | FaultLevel |
| record_success | service | None |
| get_failure_count | service | int |
| get_level | service | FaultLevel |
| is_faulty | service | bool |
| is_warning | service | bool |
| is_critical | service | bool |
| get_all_statuses | - | dict[str, dict[str, Any]] |
| events | - | list[FaultEvent] |
| get_service_events | service | list[FaultEvent] |
| threshold | - | int |
| threshold | value | None |
| window_sec | - | float |
| window_sec | value | None |
| reset | service | None |
| _compute_level | count | FaultLevel |
| _log_level_change | service, level, count | None |

#### 函数

| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| get_fault_detector | - | FaultDetector | 否 |

---

### backend.resilience.self_healing
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | service, status, recovery_succeeded, degradation_level, latency_ms, error | None |
| to_dict | - | dict[str, Any] |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | service, recovery, degradation, probe, cooldown_sec, probe_interval_sec | None |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | fault_detector, history_size | None |
| register_service | service, recovery, degradation, probe, cooldown_sec, probe_interval_sec | None |
| unregister_service | service | None |
| record_failure | service | None |
| record_success | service | None |
| heal | service | HealingAttempt |
| heal_many | services | list[HealingAttempt] |
| heal_all_faulty | - | list[HealingAttempt] |
| is_degraded | service | bool |
| get_degradation_level | service | DegradationLevel |
| get_degraded_services | - | dict[str, DegradationLevel] |
| probe_service | service | bool |
| probe_all_degraded | - | dict[str, bool] |
| start | check_interval | None |
| _monitor_loop | interval | None |
| stop | - | None |
| history | - | list[HealingAttempt] |
| get_service_history | service | list[HealingAttempt] |
| get_status | - | dict[str, Any] |
| _determine_degradation_level | service | DegradationLevel |

#### 函数

| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| degrade_database | level | None | 是 |
| degrade_redis | level | None | 是 |
| degrade_llm_service | level | None | 是 |
| get_self_healing | - | SelfHealing | 否 |

---

### backend.resilience.__init__
...
| deep_health_check | critical_only | dict | 是 |
| _get_system_info | - | dict | 否 |
| _get_service_status | - | dict | 是 |
| _check_redis | - | str | 是 |
| _check_database | - | str | 是 |
| _get_pool_stats | - | dict | None | 否 |
| pool_health | - | dict | 是 |
| pool_history | last_n | dict | 是 |
...
| :--- | :--- | :--- |
| __init__ | - | None |
| register | name, task | None |
| unregister | name | None |
| task_names | - | list[str] |
| last_report | - | WarmupReport | None |
| warmup | name | WarmupResult |
| warmup_all | - | WarmupReport |
| start_background_warmup | interval | None |
| stop | - | None |
| _run_task | name, task | WarmupResult |

#### 函数

| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| get_cache_warmer | - | CacheWarmer | 否 |
| reset_cache_warmer | - | None | 否 |
| warmup_poi_cache | - | None | 是 |
| warmup_city_category_cache | - | None | 是 |
| warmup_user_profiles | - | None | 是 |
| warmup_other_datasets | - | None | 是 |
| _register_default_tasks | warmer | None | 否 |
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| get_pool_manager | - | PoolManager | 否 |
| reset_pool_manager | - | None | 否 |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | db_pool, http_pool, utilization_warn_threshold, history_max_size | None |
| get_stats | - | dict[str, Any] |
| collect_stats | - | None |
| get_history | last_n | list[dict[str, Any]] |
...
### backend.tests.test_fault_detector
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| test_initial_state_healthy | - | None |
| test_record_failure_increments_count | - | None |
| test_warning_at_half_threshold | - | None |
| test_critical_at_eighty_percent | - | None |
| test_faulty_at_threshold | - | None |
| test_record_success_resets_count | - | None |
| test_window_expiration | - | None |
| test_different_services_independent | - | None |
| test_events_recorded_on_level_change | - | None |
| test_no_duplicate_events_same_level | - | None |
| test_reset_single_service | - | None |
| test_reset_all | - | None |
| test_get_all_statuses | - | None |
| test_threshold_setter_validation | - | None |
| test_window_sec_setter_validation | - | None |
| test_events_history | - | None |
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| _reset_locale_contextvar | - | None | 否 |
...
| test_unsupported_locale_falls_back | client | None |
| test_en_gb_falls_back | client | None |

#### 函数

| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| _load_locale_middleware | - | - | 否 |
| app | - | FastAPI | 否 |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| test_returns_event_when_no_exc_info | - | None |
| test_filters_keyboard_interrupt | - | None |
| test_filters_system_exit | - | None |
| test_filters_cancelled_error | - | None |
| test_filters_rate_limit_message | - | None |
| test_filters_too_many_requests_message | - | None |
| test_filters_connection_reset_message | - | None |
| test_passes_normal_exception | - | None |
| test_sanitizes_authorization_header | - | None |
| test_sanitizes_cookie_header | - | None |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| test_filters_health_endpoint | - | None |
| test_filters_healthz_endpoint | - | None |
| test_filters_metrics_endpoint | - | None |
| test_passes_normal_endpoint | - | None |
| test_passes_empty_transaction | - | None |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| test_returns_false_when_no_dsn | - | None |
| test_returns_true_when_dsn_set | mock_init | None |
| test_passes_integrations | mock_init | None |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| test_calls_sdk_without_context | mock_cap | None |
| test_calls_sdk_with_context | mock_cap | None |
...
### backend.tests.test_self_healing
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| test_heal_no_registered_service | healing | None |
| test_heal_recovery_success | healing | None |
| test_heal_recovery_failure_degrades | healing, detector | None |
| test_heal_already_degraded_skips | healing, detector | None |
| test_heal_cooldown | healing | None |
| test_heal_many | healing | None |
| test_heal_many_empty | healing | None |
| test_heal_all_faulty | healing, detector | None |
| test_record_success_exits_degradation | healing, detector | None |
| test_is_degraded_false_by_default | healing | None |
| test_get_degradation_level_default | healing | None |
| test_get_degraded_services | healing | None |
| test_probe_service_recovery | healing, detector | None |
| test_probe_service_still_down | healing, detector | None |
| test_probe_service_no_config | healing | None |
| test_probe_service_not_degraded | healing | None |
| test_probe_all_degraded | healing | None |
| test_unregister_service | healing | None |
| test_history | healing | None |
| test_get_status | healing | None |
| test_determine_degradation_level_faulty | healing, detector | None |
| test_determine_degradation_level_critical | healing, detector | None |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| test_degrade_database | - | None |
| test_degrade_redis | - | None |
| test_degrade_llm_service | - | None |

#### 函数

| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| detector | - | FaultDetector | 否 |
| healing | detector | SelfHealing | 否 |
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| _print_result | label, result | bool | 否 |
| main | argv | int | 否 |

---

### backend.tools.check_dependencies
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| _print_outdated | result | None | 否 |
| _print_security | result | None | 否 |
| _print_tree | result | None | 否 |
| _print_recommendations | result | None | 否 |
| main | - | None | 否 |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | source_dir | None |
| run_ruff_check | - | CheckResult |
| run_mypy_check | - | CheckResult |
| run_black_check | - | CheckResult |
| analyze_complexity | - | CheckResult |
| analyze_maintainability | - | CheckResult |
| run_all | - | ReviewReport |

#### 函数

| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| _run_tool | cmd | subprocess.CompletedProcess[str] | 否 |

---

### backend.tools.config_validator
...
| __init__ | - | None |
| reset | - | None |
| validate_env_file | env_file | ValidationResult |
| validate_required_vars | - | ValidationResult |
| validate_config_consistency | - | ValidationResult |
| _check_environment | result | None |
| _check_port | result, var_name, default | None |
| _check_log_level | result | None |
| _check_positive_int | result, var_name, default | None |
| _check_data_dir | result | None |
| validate_all | env_file | dict[str, ValidationResult] |
| is_valid | env_file | bool |

---

### backend.tools.dependency_checker
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | requirements_file | None |
| check_outdated | - | CheckResult |
| check_security | - | CheckResult |
| get_dependency_tree | - | CheckResult |
| get_update_recommendations | - | CheckResult |
| _classify_update | current, latest | str |
| _parse_audit_output | output | list[dict[str, str]] |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | docs_dir, source_dir, project_name | None |
| generate_api_doc | api_spec | str |
| generate_sdk_doc | - | str |
| generate_guide_doc | - | str |
| generate_changelog | version, changes, date | str |
| generate_all_docs | - | dict[str, Path] |
| save_doc | filename, content | Path |
| get_version_history | - | list[DocVersion] |
| create_version | version, files | DocVersion |
| diff_versions | version_a, version_b | dict[str, Any] | None |
| search_docs | keyword | list[SearchResult] |
| search_in_file | filename, keyword | list[str] |
| get_stats | - | DocStats |
| _generate_from_openapi | api_spec | str |
| _record_version | version, files | None |
| _load_versions | - | list[DocVersion] |
| _save_versions | versions | None |
| _get_git_versions | - | list[DocVersion] |
| _get_current_commit_hash | - | str |
| _parse_diff_files | diff_output | list[str] |
| _extract_snippets | content, keyword | list[str] |

---

### backend.tools.log_analyzer
...
| parse_log_line | line, source_file | LogEntry | None |
| parse_log_file | log_file | list[LogEntry] |
| parse_all | - | list[LogEntry] |
| search_logs | keyword, level, case_sensitive | list[LogEntry] |
| search_by_time_range | start, end | list[LogEntry] |
| get_statistics | - | LogStatistics |

---

### backend.tools.maintain_docs
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| _print_separator | title | None | 否 |
| _print_success | message | None | 否 |
| _print_info | message | None | 否 |
| _print_error | message | None | 否 |
| cmd_generate | maintainer, args | int | 否 |
| cmd_search | maintainer, args | int | 否 |
| cmd_versions | maintainer, args | int | 否 |
| cmd_create_version | maintainer, args | int | 否 |
| cmd_stats | maintainer, args | int | 否 |
| cmd_diff | maintainer, args | int | 否 |
| main | argv | int | 否 |
...
### backend.tools.optimization_advisor
...
| get_top_n | analysis, n | list[Recommendation] |
| get_summary | analysis | dict[str, Any] |

---

### backend.tools.performance_analyzer
...
| :--- | :--- | :--- |
| __init__ | - | None |
| analyze_response_times | metrics | list[Bottleneck] |
| analyze_memory_usage | metrics | list[Bottleneck] |
| analyze_cache_hitrate | metrics | list[Bottleneck] |
| analyze_error_rate | metrics | list[Bottleneck] |
| analyze_db_queries | metrics | list[Bottleneck] |
| analyze_all | metrics | AnalysisReport |
| generate_report | - | dict[str, Any] |

---

### backend.tools.query_logs
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| _build_parser | - | argparse.ArgumentParser | 否 |
| show_statistics | analyzer | None | 否 |
| search_and_display | analyzer, keyword, level, limit | None | 否 |
| main | - | None | 否 |

---

### backend.tools.resource_cleaner
...
| :--- | :--- | :--- |
| __init__ | - | None |
| clean_temp_files | temp_dir, max_age_days | None |
| clean_cache | cache_dir, max_size_mb | None |
| clean_logs | log_dir, max_age_days | None |
| get_report | - | dict[str, Any] |
| reset | - | None |

---

### backend.tools.run_cleanup
...
| :--- | :--- | :--- | :--- |
| _print_separator | title | None | 否 |
| _print_report | report, verbose | None | 否 |
| main | argv | int | 否 |

---

### backend.tools.run_tests
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| run_command | cmd, label | subprocess.CompletedProcess[str] | 否 |
| run_tests | include_slow, use_coverage, module, output_html, verbose | int | 否 |
| main | - | None | 否 |

---

### backend.tools.test_config
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| discover_test_files | directory, pattern | list[Path] | 否 |
| get_test_paths | config | list[str] | 否 |
| collect_markers | directory | dict[str, int] | 否 |
| build_pytest_args | config | list[str] | 否 |

---

### backend.tools.test_report
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| from_results | results | TestSummary |
...
| 方法 | 参数 | 返回值 |
| :--- | :--- | :--- |
| __init__ | project_name | None |
| add_result | test_name, passed, duration, details, nodeid, marker | None |
| load_from_json | json_path | None |
| load_from_xml | xml_path | None |
| load_coverage_xml | coverage_path | None |
| results | - | list[TestResult] |
| generate_summary | - | TestSummary |
| generate_html_report | - | str |
| save_report | filename | Path |
| _extract_call_repr | test | str |
| _extract_marker | test | str |
| _html_header | - | str |
| _html_summary | summary | str |
| _html_coverage_section | - | str |
| _html_detail_table | - | str |
| _html_footer | - | str |
...
| 函数 | 参数 | 返回值 | 异步 |
| :--- | :--- | :--- | :--- |
| generate_report_from_files | xml_path, coverage_path, output_path, project_name | Path | 否 |

---

### backend.tools.test_runner
...
| run_tests | - | TestRunResult |
| run_specific_test | test_file | TestRunResult |
| run_with_coverage | - | TestRunResult |
| history | - | list[TestRunResult] |
| generate_html_report | result | Path | None |
| _execute | args | TestRunResult |
| _parse_pytest_output | output | dict[str, int] |
